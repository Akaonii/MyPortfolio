...
import { ShieldCheck, BookOpen, ExternalLink, FileText, Award } from 'lucide-react';
      ...
      >
        <div className="space-y-8">
          ...
          <div className="text-slate-400 text-lg leading-relaxed space-y-6 font-light">
            <p>
              Passionated about cybersecurity for <span className="text-white font-bold">5 years</span>, 
